...
async def UpdateDatabase(guild, table, row, add, new_value, old_value=None):
    ...
    if row == "moderators" or row == "admins" or row == "users":
        ...
        if add == True:
            ...
            if str(new_value) in current_value:
                ...
                current_value[:] = [
                    value for value in current_value if value != str(new_value)]
    ...
    url = "http://localhost/old/API/jupikd_discord/updatedatabase.php"
    params = {
...
async def CreateCustomPermission(guild, name):
    ...
    url = "http://localhost/old/API/jupikd_discord/createcustompermission.php"
    params = {
        "key": config.jupsapikey,
        "serverid": guild.id,
        "name": name
...
async def DeleteCustomPermission(guild, name):
    ...
    url = "http://localhost/old/API/jupikd_discord/deletecustompermission.php"
    params = {
        "key": config.jupsapikey,
        "serverid": guild.id,
        "name": name
...
async def UpdateCustomPermission(guild, name, row, add, old_value, new_value):
    ...
    url = "http://localhost/old/API/jupikd_discord/updatecustompermission.php"
    params = {
        "key": config.jupsapikey,
        "serverid": guild.id,
        "name": name,
...
async def CreateBlacklistedWord(guild, channel):
    # Call a post request to the API to create the permission.
    url = "http://localhost/old/API/jupikd_discord/createblacklistedword.php"
    params = {
        "key": config.jupsapikey,
        "serverid": guild.id,
        "channel": channel
...
async def DeleteBlacklistedWord(guild, channel):
    # Call a post request to the API to delete the permission.
    url = "http://localhost/old/API/jupikd_discord/deleteblacklistedword.php"
    params = {
        "key": config.jupsapikey,
        "serverid": guild.id,
        "channel": channel
...
async def UpdateBlacklistedWord(guild, channel, add, new_value):
    ...
    url = "http://localhost/old/API/jupikd_discord/updateblacklistedwords.php"
    params = {
        "key": config.jupsapikey,
        "serverid": guild.id,
        "channel": channel,
...
async def CreateServerDefaultCommandPermission(guild, name, permission):
    # Call a post request to the API to create the permission.
    url = "http://localhost/old/API/jupikd_discord/createserverdefaultcommandpermission.php"
    params = {
        "key": config.jupsapikey,
        "serverid": guild.id,
        "name": name,
...
async def DeleteServerDefaultCommandPermission(guild, name):
    # Call a post request to the API to delete the permission.
    url = "http://localhost/old/API/jupikd_discord/deleteserverdefaultcommandpermission.php"
    params = {
        "key": config.jupsapikey,
        "serverid": guild.id,
        "name": name
...
async def UpdateServerDefaultCommandPermission(guild, name, row, new_value):
    ...
    url = "http://localhost/old/API/jupikd_discord/updateserverdefaultcommandpermission.php"
    params = {
        "key": config.jupsapikey,
        "serverid": guild.id,
        "name": name,
